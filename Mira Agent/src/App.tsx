          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Upload a CSV and select from available descriptions to find matching tasks
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-center gap-2 text-blue-800">
                ...
                <span className="font-medium">
                  Dataset loaded: {csvData.length} records with {Array.from(new Set(csvData.map(row => row.Description))).length} unique descriptions
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto space-y-4">
              ...
              <p className="text-gray-600">
                Upload a CSV file with Task, Description, Actions, and Objects columns to begin selecting from available descriptions.
              </p>
            </div>
          </div>
        )}
