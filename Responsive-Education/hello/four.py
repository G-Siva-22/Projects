...
face_classifier_path = r"C:\Users\Asus\Desktop\Projects\Responsive-Education\haarcascade_frontalface_default.xml"
model_path = r"C:/Users/Asus/Desktop/Projects/Responsive-Education/model.h5"

# Check if files exist
if not os.path.exists(face_classifier_path):
    raise FileNotFoundError(f"Face classifier not found at {face_classifier_path}")
